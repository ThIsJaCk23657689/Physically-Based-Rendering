    ...
    }
    {
        ...
        if ( ImGui::BeginTabBar( "TabBar" ) )
        {
            ...
            if ( ImGui::BeginTabItem( "Camera" ) )
            {
                ...
                ImGui::Text(
                    "Position = (%.2f, %.2f, %.2f)", camera->m_Position.x, camera->m_Position.y, camera->m_Position.z );
                ImGui::Text(
                    "Velocity = (%.2f, %.2f, %.2f)", camera->m_Velocity.x, camera->m_Velocity.y, camera->m_Velocity.z );
